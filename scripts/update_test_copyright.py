...
"""Script to update copyright headers in test Python files."""
...
def main():
    ...
    print(f"Found {len(python_files)} Python test files to update")
    ...
    for filepath in python_files:
        try:
            if update_file(filepath):
                updated += 1
                print(f"✓ Updated {filepath.relative_to(tests_dir.parent)}")
