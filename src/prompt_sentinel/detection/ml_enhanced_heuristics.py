...
class MLEnhancedHeuristicDetector(HeuristicDetector):
    ...
    ) -> Tuple[List[DetectionReason], float]:
            ...
            for pattern in self._ml_patterns:
                try:
                    if pattern.test(text):
                        ...
                        logger.debug("ML pattern matched",
                                   pattern_id=pattern.pattern_id,
                                   category=pattern.category,
                                   confidence=pattern.confidence)
                        
                except Exception as e:
                    logger.warning("Error testing ML pattern",
                                 pattern_id=pattern.pattern_id,
                                 error=str(e))
    ...
    def get_pattern_statistics(self) -> Dict[str, any]:
        ...
        return {
            ...
            "last_refresh": self._last_pattern_refresh.isoformat() if self._last_pattern_refresh else None
        }