...
class PromptProcessor:
    ...
    @staticmethod
    def validate_role_separation(messages: List[Message]) -> Tuple[bool, List[FormatRecommendation]]:
        ...
        properly_formatted = has_system and has_user and (
            not system_indices or not user_indices or max(system_indices) < min(user_indices)
        )
