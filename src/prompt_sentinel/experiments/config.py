...
class ExperimentMetadata(BaseModel):
    ...
    # Performance metrics
    experiment_overhead_ms: float = Field(default=0.0, 
                                        description="Average experiment overhead")
    assignment_cache_hit_rate: float = Field(default=0.0,
                                           description="Assignment cache hit rate")
