...
class FeatureExtractor:
    ...
    def get_feature_importance(self, features: List[FeatureVector]) -> Dict[str, float]:
        ...
        feature_names = [
            ...
            'entropy', 'char_diversity', 'word_diversity', 'avg_word_length',
            'punctuation_ratio', 'special_char_ratio', 'uppercase_ratio',
            'digit_ratio', 'whitespace_ratio', 'has_encoding', 'has_delimiters',
            'has_role_markers', 'has_instructions', 'max_repetition'
        ]
