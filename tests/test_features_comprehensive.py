...
class TestFeatureExtractor:
    ...
    def test_compute_similarity_with_embeddings(self, extractor):
        ...
        vec1 = FeatureVector(
            length=10, word_count=2, char_count=8, line_count=1,
            entropy=1.0, char_diversity=0.5, word_diversity=0.5,
            avg_word_length=4.0, punctuation_ratio=0.1,
            special_char_ratio=0.1, uppercase_ratio=0.1,
            digit_ratio=0.0, whitespace_ratio=0.2,
            has_encoding=False, has_delimiters=False,
            has_role_markers=False, has_instructions=False,
            max_repetition=1, char_ngrams={}, word_ngrams={},
    ...
    def test_compute_similarity_without_embeddings(self, extractor):
        ...
        vec1 = FeatureVector(
            length=100, word_count=20, char_count=80, line_count=2,
            entropy=3.0, char_diversity=0.7, word_diversity=0.8,
            avg_word_length=4.0, punctuation_ratio=0.1,
            special_char_ratio=0.1, uppercase_ratio=0.05,
            digit_ratio=0.02, whitespace_ratio=0.2,
            has_encoding=False, has_delimiters=True,
            has_role_markers=False, has_instructions=True,
            max_repetition=2, char_ngrams={"th": 5}, word_ngrams={"the": 2}
        )
    ...
    def test_compute_similarity_edge_cases(self, extractor):
        ...
        vec1 = FeatureVector(
            length=0, word_count=0, char_count=0, line_count=0,
            entropy=0.0, char_diversity=0.0, word_diversity=0.0,
            avg_word_length=0.0, punctuation_ratio=0.0,
            special_char_ratio=0.0, uppercase_ratio=0.0,
            digit_ratio=0.0, whitespace_ratio=0.0,
            has_encoding=False, has_delimiters=False,
            has_role_markers=False, has_instructions=False,
            max_repetition=0, char_ngrams={}, word_ngrams={},
