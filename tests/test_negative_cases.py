...
class TestDataCorruption:
    ...
    def test_circular_json_serialization(self):
        ...
        result = DetectionResponse(
            verdict=Verdict.BLOCK, confidence=0.9, reasons=[reason], processing_time_ms=10.5
        )
...
class TestConcurrencyIssues:
    ...
    async def test_cache_race_conditions(self):
        ...
        config = {
            ...
            "providers": {"anthropic": {"api_key": "test-key", "model": "claude-3"}},
            "cache_ttl": 60,
        }
    ...
    async def test_provider_failover_exhaustion(self):
        ...
        with (
            ...
            for provider_name in manager.providers:
                ...
                provider.classify = AsyncMock(side_effect=Exception(f"{provider_name} failed"))
